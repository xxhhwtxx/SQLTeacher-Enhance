...
[![Target: SQLTeacher v3.8.0+](https://img.shields.io/badge/Target-SQLTeacher%20v3.8.0+-emerald.svg)](https://github.com/danlingdan/Teacher/releases/tag/v3.8.0)
...
![调色板实机截图](assets/preview-palette.png)
...
![动态壁纸画廊实机截图](assets/preview-wallpaper.png)
...
![动效氛围与番茄钟截图](assets/preview-atmosphere.png)
...
![按键打击感与本地音频上传截图](assets/preview-audio.png)
...
![每日刷题热力打卡墙截图](assets/preview-heatmap.png)
